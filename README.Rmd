...
<!-- badges: start -->
[![CRAN version](https://www.r-pkg.org/badges/version/RiskMap)](https://cran.r-project.org/package=RiskMap)
...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/RiskMap)](https://cran.r-project.org/package=RiskMap)
[![Total downloads](https://cranlogs.r-pkg.org/badges/grand-total/RiskMap)](https://cran.r-project.org/package=RiskMap)
[![lifecycle](https://img.shields.io/badge/lifecycle-maturing-blue.svg)](https://lifecycle.r-lib.org/articles/stages.html)
<!-- badges: end -->

## Overview

`RiskMap` provides tools for model-based geostatistical analysis of continuous,
...
For a full applied guide to using `RiskMap` in real public health workflows,
